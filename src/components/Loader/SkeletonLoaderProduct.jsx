...
const SkeletonLoaderProduct = () => {
    return (
        <div className=" w-full flex justify-center items-start gap-[20px] h-[75vh] pt-[50px] " >

            <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center w-full px-[50px] ">
                <div class="flex items-center justify-center w-[80%] min-h-[310px] bg-gray-300 rounded-sm dark:bg-gray-400">
                    <svg class="w-10 h-10 text-gray-200 dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
