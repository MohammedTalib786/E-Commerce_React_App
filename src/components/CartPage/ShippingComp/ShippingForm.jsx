            ...
            <div className=""  >
                ...
                <div
                    ...
                    <div className="countryCont relative "  >
                        <InputBar label_text="Country" html_htmlFor="country" id="country" read_only={true} type="text" value="India" onclick_func={handlerCountryInp}
                        />
                        {
                            countryMsg &&
                    ...
                    <div className="townCityCont relative "  >
                        <InputBar label_text="Town/City" html_htmlFor="town-city" id="town-city" type="text" onChange_func={(e) => setFormData({ ...formData, town_cityInp: e.target.value })}
                        />
                        {
                            errorMsg.townCity &&
                    ...
                    <div className="pinCodeCont relative "  >
                        <InputBar label_text="PinCode" html_htmlFor="pincode" id="pincode" type="number" onChange_func={(e) => setFormData({ ...formData, pincodeInp: Number(e.target.value) })}
                        />
                        {
                            errorMsg.pincode &&
                            <p className='bg-red-800 text-white  absolute w-auto text-center top-[0px] left-[90px] text-[15px]/[21px] px-[16px] py-[10px] rounded-[12px]  ' >
